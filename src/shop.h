...
************************************************************************ */
/* $Id: shop.h,v 1.6 2002/07/03 15:38:07 arcanere Exp $ */
...
#define	TRADE_NOMAGI_TYPE       (1 << 3)
#define	TRADE_NOCLERIC_TYPE     (1 << 4)
#define	TRADE_NOTHIEF_TYPE      (1 << 5)
#define	TRADE_NOWARRIOR_TYPE    (1 << 6)
...
#define	NOTRADE_MAGI_TYPE(i)    (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMAGI_TYPE))
#define	NOTRADE_CLERIC_TYPE(i)  (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOCLERIC_TYPE))
#define	NOTRADE_THIEF_TYPE(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOTHIEF_TYPE))
#define	NOTRADE_WARRIOR_TYPE(i) (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOWARRIOR_TYPE))
