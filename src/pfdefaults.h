/* $Id: pfdefaults.h,v 1.9 2004/04/23 15:18:10 cheron Exp $ */
...
#define	PFDEF_AC          0
#define	PFDEF_STRENGTH    0
#define	PFDEF_STRADD      0
#define	PFDEF_AGILITY     0
#define	PFDEF_PRECISION   0
#define	PFDEF_PERCEPTION  0
#define	PFDEF_HEALTH      0
#define	PFDEF_WILLPOWER   0
#define	PFDEF_INTELL      0
#define	PFDEF_CHARISMA    0
#define	PFDEF_LUCK        0
#define	PFDEF_ESSENCE     0
#define	PFDEF_HIT         0
...
#define PFDEF_SKILLCAP		0
#define	PFDEF_HUNGER      0
#define	PFDEF_THIRST      0
#define	PFDEF_DRUNK       0
#define	PFDEF_CLAN        0
#define	PFDEF_CLANRANK    0
#define	PFDEF_USERRIGHTS  0
#define PFDEF_XSYSLOG			0
#define PFDEF_MAILINGLIST	NO
#define PFDEF_EYECOLOR		0
#define	PFDEF_HAIRCOLOR		0
#define	PFDEF_HAIRSTYLE		0
#define	PFDEF_SKINTONE		0
